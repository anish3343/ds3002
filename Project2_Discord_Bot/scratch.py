...
content = "WEATHER IN MUMBAI"#input().upper()
...
if not places.cities:
    print("Hmm. Either you didn't specify a city, or I couldn't find the city you entered.")
